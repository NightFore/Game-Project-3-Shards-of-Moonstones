...
# Enemy
    ...
    if GameStateIG.Enemy_Slot[0] == True:
        Variable = 0
        gameDisplay.blit(GameStateIG.Enemy[Variable].Icon,     (465, 75+75*Variable))
        Text_Fight("%s" % GameStateIG.Enemy[Variable].name,    515, 85)
        
    # Enemy 2
    if GameStateIG.Enemy_Slot[1] == True:
        Variable += 1
        gameDisplay.blit(GameStateIG.Enemy[Variable].Icon,     (465, 75+75*Variable))
        Text_Fight("%s" % GameStateIG.Enemy[Variable].name,    515, 85+75*Variable)

    # Enemy 3
    if GameStateIG.Enemy_Slot[2] == True:
        Variable += 1
        gameDisplay.blit(GameStateIG.Enemy[Variable].Icon,     (465, 75+75*Variable))
        Text_Fight("%s" % GameStateIG.Enemy[Variable].name,    515, 75+75*Variable)
...
# Total Gain
    ...
    Text_Fight("+%i" % GameStateIG.Experience_Gain, 460, 360)
