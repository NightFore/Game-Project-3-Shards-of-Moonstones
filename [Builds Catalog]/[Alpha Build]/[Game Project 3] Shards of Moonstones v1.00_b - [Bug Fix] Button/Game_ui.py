...
def Game_ui(events):
    ...
    # Commands
    Button("Attack", 400-48, 450+2, 100-3, 50-5, Command_Button, red, Text_Title_Selection, events, Attack)
    Button("Magic",  400-48, 500+2, 100-3, 50-5, Command_Button, red, Text_Title_Selection, events, Magic)
    Button("Guard",  400-48, 550+2, 100-3, 50-5, Command_Button, red, Text_Title_Selection, events, Guard)
