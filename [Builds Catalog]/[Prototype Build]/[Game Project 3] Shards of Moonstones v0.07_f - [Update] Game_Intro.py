...
# Setup
    ...
    # Game Intro 1 :
        ...
        if GameStateIG.Event[1] == False :
            ...
            if GameStateIG.Text_Order == 3:
                GameStateIG.Text_Line_Right[2] = ("You are my new summon.")
                GameStateIG.Text_Line_Right[3] = "-> (Press Enter)"
            ...
            if GameStateIG.Text_Order == 5:
                ...
                GameStateIG.Text_Line_Right[3] = ("It means that I will watch over you.")
                GameStateIG.Text_Line_Right[4] = "-> (Press Enter)"
            
            if GameStateIG.Text_Order == 6:
                GameStateIG.Text_Line_Right[4] = ("But also that you have to obey me.")
