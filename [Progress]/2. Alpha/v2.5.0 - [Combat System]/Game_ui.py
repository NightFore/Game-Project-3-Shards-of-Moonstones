...
def Attack_Choice():
    ...
    if GameStateIG.Enemy_Slot[0] == True and GameStateIG.Enemy_Death[0] == False:
        Button("", 630, 260, 50, 50, Command_Button, red, Text_Title_Selection, GameStateIG.event, 0, Attack)

    if GameStateIG.Enemy_Slot[1] == True and GameStateIG.Enemy_Death[1] == False:
        Button("", 630, 310, 50, 50, Command_Button, red, Text_Title_Selection, GameStateIG.event, 1, Attack)

    if GameStateIG.Enemy_Slot[2] == True and GameStateIG.Enemy_Death[2] == False:
        Button("", 630, 360, 50, 50, Command_Button, red, Text_Title_Selection, GameStateIG.event, 2, Attack)
