...
def Attack():
    Accuracy = (50 + (0.5*PlayerIG.Level)) * (PlayerIG.Speed**2 / Ennemy_1.Speed**2)
    Hit = random.randint(0, 100)
    print("Accuracy :", Accuracy)
    print("Hit :", Hit)
    if Accuracy >= Hit:
        Ennemy_1.Health -= PlayerIG.Strength
...
def Game_ui():
    ...
    # Commands
    Button("Attack", 400-48, 450+2, 100-3, 50-5, green, red, Text_Title_Selection, Attack)
    Button("Magic",  400-48, 500+2, 100-3, 50-5, green, red, Text_Title_Selection, Magic)
    Button("Guard",  400-48, 550+2, 100-3, 50-5, green, red, Text_Title_Selection, Guard)
