...
def Game_ui():
    Text_Fight("%s" % PlayerIG.name, 55, 470)
    Text_Fight(GameStateIG.Text_Line_Left[2], 60, 510)
    Text_Fight(GameStateIG.Text_Line_Left[3], 60, 550)
    Text_Fight(GameStateIG.Text_Line_Left[4], 60, 590)
    Text_Fight(GameStateIG.Text_Line_Left[5], 60, 630)
    Text_Fight(GameStateIG.Text_Line_Left[6], 60, 670)
    Text_Fight(GameStateIG.Text_Line_Left[7], 60, 7100)
