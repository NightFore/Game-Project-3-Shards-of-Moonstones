...
def Title_Screen():
    ...
    while not gameExit:
        ...
        for event in pygame.event.get():
            ...
            # Commands
            Button("Start", 150, 425, 100, 50, green, red, Text_Title_Selection, events, Game_Intro_1)
            Button("Load",  350, 425, 100, 50, green, red, Text_Title_Selection, events, Game_Load)
            Button("Exit",  550, 425, 100, 50, green, red, Text_Title_Selection, events, Quit_Game)
...
def Main_Game():
    Level_Fight()
    if GameStateIG.Fight_Event[3] == True:
        Game_ui(events)
